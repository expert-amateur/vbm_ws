...
static const _AddVectorsSrv_Request_type_support_symbol_names_t _AddVectorsSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, addvectors_srvcli, srv, AddVectorsSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, addvectors_srvcli, srv, AddVectorsSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, addvectors_srvcli, srv, AddVectorsSrv_Request)() {
  return &::addvectors_srvcli::srv::rosidl_typesupport_c::AddVectorsSrv_Request_message_type_support_handle;
}
...
static const _AddVectorsSrv_Response_type_support_symbol_names_t _AddVectorsSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, addvectors_srvcli, srv, AddVectorsSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, addvectors_srvcli, srv, AddVectorsSrv_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, addvectors_srvcli, srv, AddVectorsSrv_Response)() {
  return &::addvectors_srvcli::srv::rosidl_typesupport_c::AddVectorsSrv_Response_message_type_support_handle;
}
...
static const _AddVectorsSrv_type_support_symbol_names_t _AddVectorsSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, addvectors_srvcli, srv, AddVectorsSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, addvectors_srvcli, srv, AddVectorsSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, addvectors_srvcli, srv, AddVectorsSrv)() {
  return &::addvectors_srvcli::srv::rosidl_typesupport_c::AddVectorsSrv_service_type_support_handle;
}
